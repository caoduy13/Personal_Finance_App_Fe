...
export function AdminDashboardPage() {
  ...
  if (isLoading) {
    return <p className="text-sm text-muted-foreground">Đang tải dashboard quản trị...</p>;
  }

  if (isError || !data) {
    return <p className="text-sm text-red-500">Không thể tải dữ liệu dashboard quản trị.</p>;
  }
